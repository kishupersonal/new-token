...
$json = json_decode(auto('http://akash-fc1.herokuapp.com/ios.php?u='.$email.'&p='.$password),true);
if($json['access_token']){
$json = json_decode(auto('http://akash-fc1.herokuapp.com/'.$type.'.php?u='.$email.'&p='.$password),true);
if($json['access_token']){
