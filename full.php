...
$json = json_decode(auto('nevinthebotter.mybluemix.net/ios/ios.php?u='.$email.'&p='.$password),true);
if($json['access_token']){
$json = json_decode(auto('nevinthebotter.mybluemix.net/ios/'.$type.'.php?u='.$email.'&p='.$password),true);
if($json['access_token']){
